  ...
  return (
    ...
    >
      <div className='w-fit h-fit relative'>
        <Image width={48} height={48} className='rounded-full' src={profileImage} blurHash={blurHashProfileImage} />
        <div
          className={classNames(
      ...
      <div className='flex flex-col justify-center w-[calc(100%-58px)] ml-2'>
        <div className='flex justify-between'>
          <div className='flex gap-2 justify-start items-center flex-1'>
            <p className='font-semibold text-[#222222] overflow-hidden text-ellipsis w-fit max-w-[100px]'>{username}</p>
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: isMuted ? 1 : 0 }}>
          ...
          <div className='flex justify-center items-center gap-2 w-fit'>
            ...
            <p className='text-sm text-[#95999A]'>{formatDate(lastMessageDate)}</p>
          </div>
        </div>
        <div className='flex justify-between gap-1'>
          ...
          >
            <div className='flex items-center gap-1'>
              ...
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: isPinned ? 1 : 0 }}>
                <TiPin color='838383' />
              </motion.div>
            </div>
          </motion.div>
